...
<body>
    <div class="header">
        ...
        <ul class="inline">
            <li>
                <div id="divv">
                    <img src="../images/32/client.png" />&nbsp;&nbsp;欢迎您,
                </div>
            </li>
            <li>
                <img src="../images/32/200.png" />&nbsp;&nbsp;<a class="loginout" href="../../login.html">注销</a>&nbsp;&nbsp;<a class="loginout" id="pwd" href="#"><font color="blue">修改密码</font></a>
            </li>
        </ul>
    </div>
    <div class="nav">
