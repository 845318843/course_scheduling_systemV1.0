    ...
    public class ToWord
    {
        ...
        public bool CourseTable1(System.Data.DataTable dt, string path, string title)
        {
            ...
            try
            {
                ...
                d.Range.Text = "                                                                                                                                                                                                                                                ";
                d.Range.Text = strtitle;    //标题名  //改
                d.Range.Font.Bold = 0;
                d.Range.Font.Name = "华文中宋";
                d.Range.Font.Size = 22;     //标题大小
                ...
                newTable2 = WordDoc.Tables.Add(wrdRngdata, 7, 4, ref Nothing, ref Nothing);   //改
                //newTable2 = WordDoc.Tables.Add(wrdRngdata, 1, 2, ref Nothing, ref Nothing);
                ...
                ////newTable2.Rows[1].Height = 38f;       //第一行高
                //newTable2.Rows[1].HeightRule = MSword.WdRowHeightRule.wdRowHeightExactly;//设置行高值为固定
                //newTable2.Cell(7, 2).Merge(newTable2.Cell(7, 4));
                //newTable2.Cell(7, 2).Width = 210f;//第7行第2列
                //newTable2.Borders.OutsideLineStyle = MSword.WdLineStyle.wdLineStyleSingle;
                ...
                //newTable2.Columns[1].Width = 30f;     //第一列宽
                //newTable2.Columns[2].Width = 135f;
                //newTable2.Rows[7][2].Width = 30f;
                for (int i = 1; i <= 7; i++)
                {
                    newTable2.Cell(i, 1).Range.Font.Size = 1;
                ...
                //newTable2.Rows[1].Range.Font.Size = 14;//第一行字体大小
                //newTable2.Rows[1].Range.Font.Bold = 1;//第一行实体显示

                newTable2.Cell(1, 1).Range.Text = "教学楼";
                newTable2.Cell(1, 3).Range.Text = "教室";
                newTable2.Cell(2, 1).Range.Text = "第几周";
                newTable2.Cell(2, 3).Range.Text = "周几";
                newTable2.Cell(3, 1).Range.Text = "节次";
                newTable2.Cell(3, 3).Range.Text = "名称";
                newTable2.Cell(4, 1).Range.Text = "申请人年级";
                newTable2.Cell(4, 3).Range.Text = "院系";
                newTable2.Cell(5, 1).Range.Text = "班级";
                newTable2.Cell(5, 3).Range.Text = "签字老师";
                newTable2.Cell(6, 1).Range.Text = "申请人";
                newTable2.Cell(6, 3).Range.Text = "联系电话";
                newTable2.Cell(7, 1).Range.Text = "原因";
                ...
                newTable2.Cell(7, 2).Merge(newTable2.Cell(7, 4));//合并(7,2),(7,3),(7,4)
                for (int i = 1; i <= 6; i++)
                {
                    newTable2.Rows[i].Height = 55f;             //行高
                    for (int j = 1; j <= 4; j++)
                    {
                        newTable2.Columns[j].Width = 130f;       //列宽
                        newTable2.Cell(i, j).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;
                    }
                }
                newTable2.Rows[7].Height = 55f;
                newTable2.Columns[1].Width = 130f;
                newTable2.Cell(7, 1).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;
                newTable2.Cell(7, 2).Range.ParagraphFormat.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;
                int s = 0;
                for (int k = 1; k <= 6; k++)
                {
                    for (int i = 2; i <= 4; i+=2)
                    {
                        ...
                        newTable2.Cell(k, i).Range.Text = dt.Rows[0][s].ToString();
                        s++;
                        newTable2.Cell(k, i).Range.ParagraphFormat.Alignment = MSword.WdParagraphAlignment.wdAlignParagraphLeft;
                    }
                }
                newTable2.Cell(7, 2).Range.Text = dt.Rows[0][s].ToString();
                newTable2.Cell(7, 2).Width = 390f;          //7,2列宽度为其他三倍
                newTable2.Cell(7, 2).Range.ParagraphFormat.Alignment = MSword.WdParagraphAlignment.wdAlignParagraphLeft;
                newTable2.Borders.OutsideLineStyle = MSword.WdLineStyle.wdLineStyleSingle;    //最外层框实线
                newTable2.Borders.OutsideLineWidth = MSword.WdLineWidth.wdLineWidth150pt;     //加粗
                newTable2.Borders.InsideLineStyle = MSword.WdLineStyle.wdLineStyleSingle;     //框实线
                newTable2.Borders.OutsideLineWidth = WdLineWidth.wdLineWidth225pt;
                //for (int i = 2; i <= 6; i++)
                //{
